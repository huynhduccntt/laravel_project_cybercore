<div class="top-header">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-3 hidden-sm-down top-user">
                <span><a href="#">Đăng ký</a></span>&nbsp;&nbsp;|&nbsp;
                <span><a href="#">Đăng nhập</a></span>
            </div>
            <div class="col-lg-9 col-md-9 col-sm-12">
                <div class="row no-gutters">
                    <div class="col-lg-12 top-contact">
                        <div class="top-lang">
                            <a href="#"><img src="{{ URL::to('frontEnd/images/vn.png') }}" />
                            </a>
                            <a href="#"><img src="{{ URL::to('frontEnd/images/uk.png') }}"></a>
                        </div>
...
<nav class="navbar navbar-expand-lg navbar-transparent">
    <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsExample03" aria-controls="navbarsExample03" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"><img src="{{ URL::to('frontEnd/images/collapse.png') }}"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarsExample03">
            <ul id="menu-main" class="navbar-nav ml-auto">
                ...
                <li id="menu-item-2193" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2193 nav-item"><a class="nav-link" href="/contact-us">Liên Hệ</a></li>
            </ul>
        </div>
    </div>
</nav>